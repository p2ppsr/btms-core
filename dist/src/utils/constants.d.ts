 ...
 */
export declare const TOKEN_BASKET = "tokens";
/**
 * Canonical MessageBox name for BTMS token sends.
 * New sends should target THIS box.
 */
export declare const BTMS_CANONICAL_MESSAGE_BOX = "btms-tokens";
/**
 ...
 */
export declare const BTMS_LEGACY_MESSAGE_BOXES: string[];
/**
 ...
 */
export declare const BTMS_ALL_MESSAGE_BOXES: string[];
