...
import Send from '../../components/Send'              // 👈 add this
...
try {
  ...
  const alreadyAsked = hasWindow && window.localStorage.hasRequestedGroupPermission === 'true'
  ...
  // optional: remove this or make it debug-only
