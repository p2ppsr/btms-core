...
const ExchangePage: React.FC<ExhangePageProps> = ({ btms }) => {
  ...
  const [balanceTextToWithAmountNameMapOffered, setBalanceTextToWithAmountNameMapOffered] = useState<{
    [key: string]: string
  }>({})
  ...
  const [balanceTextToWithAmountNameMapAccepted, setBalanceTextToWithAmountNameMapAccepted] = useState<{
    [key: string]: string
  }>({})
  ...
  const handleInputAmountFocusedOffered = (focused: boolean, isOffer: boolean, isAccept: boolean) => {
    dbg &&
      console.log('handleInputAmountFocusedOffered():focused=', focused, ',isOffer=', isOffer, ',isAccept=', isAccept)
  ...
  const handleInputAmountFocusedAccepted = (focused: boolean, isOffer: boolean, isAccept: boolean) => {
    dbg &&
      console.log('handleInputAmountFocusedAccepted():focused=', focused, ',isOffer=', isOffer, ',isAccept=', isAccept)
  ...
  const handleAddAssetsOffered = (amountOffer: number) => {
    ...
    dbg &&
      console.log('handleAddAssetsOffered():selectedAssetIdOffer=', selectedAssetIdOffer, ',amountOffer=', amountOffer)
    setOffer()
