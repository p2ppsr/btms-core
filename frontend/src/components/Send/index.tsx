...
// sdk / types (btms-core ambient module)
import type { Asset, SendArgs } from 'btms-core'
  ...
  const handleSend = async () => {
    try {
      ...
      if (recipient.trim() === '') {
        ...
        toast.error('The recipient identity key must be at least 66 characters long!')
    ...
    <>
      ...
      <Dialog open={open} onClose={handleSendCancel} color='primary'>
        ...
        <DialogActions className={classes.button}>
          ...
          <Button disabled={loading} color='secondary' variant='outlined' onClick={handleSend}>
            Send Now
          </Button>
        </DialogActions>
      </Dialog>
