...
const SearchBar: React.FC<SearchBarProps> = ({
  ...
  const handleOnFocus = () => {
    dbg &&
      console.log(
        "SearchBar:handleOnFocus():$isOffer=",
        $isOffer,
        ",$isAccept=",
        $isAccept,
      );
  ...
  const handleOnBlur = () => {
    dbg &&
      console.log(
        "SearchBar:handleOnClick():$isOffer=",
        $isOffer,
        ",$isAccept=",
        $isAccept,
      );
  ...
  const handleOnMouseEnter = () => {
    dbg &&
      console.log(
        "SearchBar:handleOnMouseEnter():$isOffer=",
        $isOffer,
        ",$isAccept=",
        $isAccept,
      );
  ...
  const handleOnMouseLeave = () => {
    dbg &&
      console.log(
        "SearchBar:handleOnMouseLeave():$isOffer=",
        $isOffer,
        ",$isAccept=",
        $isAccept,
      );
        ...
        InputProps={{
          ...
          startAdornment: (
            <InputAdornment position="start">
              {!focused && text === "" && (
                <IconButton size="small" disabled={!focused}>
                  <SearchIcon />
                </IconButton>
              )}
            </InputAdornment>
