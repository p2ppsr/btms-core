...
import { Table, TableRow, TableCell, TableBody, TableContainer, Grid, ThemeProvider, IconButton } from '@mui/material'
                ...
                return (
                  <TableRow
                    ...
                    style={{
                      ...
                      backgroundColor: rowClicked ? '#fff' : hoveredRow === asset.assetId ? '#2b2b2b' : 'transparent'
                    }}
                  >
                    <TableCell
                      style={{
                      ...
                      >
                        ...
                        <Grid item xs={1}>
                          {hoveredRow === asset.assetId &&
                            (rowStatus === OFFERED_TEXT || rowStatus === ACCEPTED_TEXT) && (
                              <IconButton
                                onClick={() => {
